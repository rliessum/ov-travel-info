...
- Docs and HACS metadata now match the real minimum Home Assistant version (**2024.11.0**) and list the image platform. Unused constants and unused loggers were removed. Options help text no longer mentions a scan-interval setting that was never exposed.
...
[3.5.4]: https://github.com/rliessum/ov-travel-info/releases/tag/v3.5.4
